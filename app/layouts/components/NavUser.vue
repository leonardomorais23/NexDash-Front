    ...
    <SidebarMenuItem>
      <DropdownMenu>
        <DropdownMenuTrigger as-child>
          ...
          >
            <Avatar class="h-8 w-8 rounded-lg border border-white/10">
              ...
              <AvatarFallback class="rounded-lg bg-sky-600 text-white font-bold">
        ...
        >
          <DropdownMenuLabel class="p-0 font-normal">
            <div class="flex items-center gap-2 px-1 py-1.5 text-left text-sm">
              <Avatar class="h-8 w-8 rounded-lg">
                ...
                <AvatarFallback class="rounded-lg bg-sky-600 text-white">CN</AvatarFallback>
              </Avatar>
          ...
          <DropdownMenuSeparator class="bg-white/5" />
          <DropdownMenuItem class="focus:bg-red-500/10 focus:text-red-400 text-red-400/80 cursor-pointer" @click="emit('logout')">
