...
const emit = defineEmits<{ (e: "login", payload: LoginPayload): void }>();
      ...
      <CardContent class="grid p-0 md:grid-cols-2 w-full">
        <form class="p-6 md:p-10" @submit.prevent="loginSubmit">
          <FieldGroup class="gap-6">
            ...
            <Field class="space-y-2">
              ...
              <div class="relative">
                ...
                >
                  <img
                    :src="
                      showPassword ? '/icons/Hide.svg' : '/icons/Unhide.svg'
                    "
            ...
            <Button
              type="submit"
              class="w-full bg-slate-900 hover:bg-slate-800 text-white transition-all py-6 text-lg rounded-xl"
            >
              Entrar na conta
            </Button>

            <FieldSeparator
              class="text-slate-400 text-xs uppercase tracking-widest font-bold"
            >
              Ou continue com
            </FieldSeparator>
            ...
            <Button
              variant="outline"
              type="button"
              class="border-slate-200 hover:bg-slate-50 text-slate-600 rounded-xl py-6"
            >
              <svg
                class="mr-2 h-5 w-5"
            ...
            <p class="text-center text-sm text-slate-500">
              ...
              <NuxtLink
                to="/register"
                class="ml-1 font-bold text-slate-900 hover:underline"
              >
                Crie uma agora!
              </NuxtLink>
            </p>
