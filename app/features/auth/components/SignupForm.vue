...
<template>
  <div :class="cn('flex flex-col gap-6 p-5 w-full max-w-112.5 mx-auto', props.class)">
    <Card class="border-slate-200/20 bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl">
      ...
      <CardContent>
        <form @submit.prevent="handleSubmit">
          <FieldGroup class="gap-4">
            <Field>
              <FieldLabel for="name" class="text-slate-700 font-semibold">Nome completo</FieldLabel>
              <Input
                id="name"
                v-model="name"
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <Field>
                <FieldLabel for="confirm-password" class="text-slate-700 font-semibold">Confirmar</FieldLabel>
                <Input 
                  id="confirm-password"
            ...
            <Button type="submit" class="w-full bg-slate-900 hover:bg-slate-800 py-6 text-lg rounded-xl transition-all"> 
              Finalizar Cadastro 
            </Button>
